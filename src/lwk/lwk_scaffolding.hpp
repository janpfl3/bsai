...
void * uniffi_lwk_fn_constructor_assetblindingfactor_from_hex(RustBuffer hex, RustCallStatus *out_status);
void * uniffi_lwk_fn_constructor_assetblindingfactor_from_slice(RustBuffer bytes, RustCallStatus *out_status);
...
RustBuffer uniffi_lwk_fn_method_assetblindingfactor_to_hex(void * ptr, RustCallStatus *out_status);
...
void * uniffi_lwk_fn_constructor_valueblindingfactor_from_hex(RustBuffer hex, RustCallStatus *out_status);
void * uniffi_lwk_fn_constructor_valueblindingfactor_from_slice(RustBuffer bytes, RustCallStatus *out_status);
...
RustBuffer uniffi_lwk_fn_method_valueblindingfactor_to_hex(void * ptr, RustCallStatus *out_status);
...
uint16_t uniffi_lwk_checksum_method_assetblindingfactor_to_hex();
...
uint16_t uniffi_lwk_checksum_method_valueblindingfactor_to_hex();
...
uint16_t uniffi_lwk_checksum_constructor_assetblindingfactor_from_hex();
uint16_t uniffi_lwk_checksum_constructor_assetblindingfactor_from_slice();
...
uint16_t uniffi_lwk_checksum_constructor_valueblindingfactor_from_hex();
uint16_t uniffi_lwk_checksum_constructor_valueblindingfactor_from_slice();
