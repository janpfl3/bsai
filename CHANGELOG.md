...
- Pay Lightning invoice with Liquid Bitcoin
- Swap Bitcoin and Liquid Bitcoin

### Changed
- Show 2FA options for existing multisig sessions
- Jade genuine check improvements with dedicated drawer
- Updated onboarding flow
- Updated GDK to 0.76.3
- Updated kdsingleapplication to 1.2.0
- Improvements in build scripts

### Fixed
- Check version of the installed Visual C++ Redistributable package
- Fixed several runtime execution warnings
- Fix pay BIP21 flow
