    ...
    contentItem: VFlickable {
        ...
        TTextField {
            ...
            CircleButton {
                ...
                anchors.Layout.Layout.leftMargin: 24
            ...
            Label {
                ...
                anchors.Layout.Layout.rightMargin: 24
                anchors.verticalCenter: parent.verticalCenter
                color: '#FFFFFF'
                font.pixelSize: 14
                font.weight: 500
            ...
            Label {
                ...
                anchors.Layout.Layout.bottomMargin: 8
                color: '#FFFFFF'
                font.pixelSize: 12
                font.weight: 500
                opacity: 0.7
        ...
        ErrorPane {
            Layout.Layout.topMargin: -15
            Layout.Layout.bottomMargin: 15
            error: service.error.length > 0 && !service.loading ? service.error : null
        }
        RowLayout {
            Layout.fillWidth: true
            Layout.Layout.topMargin: 3
            spacing: 8
            Repeater {
