    ...
    contentItem: VFlickable {
        ...
        ColumnLayout {
                            ...
                            linkButtons: [
                                Component {
                                    RowLayout {
                                        ...
                                        Layout.Layout.topMargin: 8
                                        Layout.fillWidth: true
                                        spacing: 8
                                        Image {
                                            source: 'qrc:/svg3/Warning.svg'
                                            Layout.alignment: Qt.AlignTop
                                            Layout.Layout.topMargin: 2
                                            width: 16
                                            height: 16
                                        }
                                        Label {
                    ...
                    Pane {
                        ...
                        contentItem: RowLayout {
                            ...
                            Rectangle {
                                ...
                                color: '#262626'
                                Layout.fillHeight: true
                                Layout.Layout.leftMargin: 12
                                Layout.Layout.rightMargin: 12
                            }
                            ColumnLayout {
                                Layout.preferredWidth: 1
                                spacing: 8
            ...
            Label {
                ...
                font.weight: 600
                color: '#FFFFFF'
                Layout.Layout.topMargin: 12
                Layout.Layout.bottomMargin: -4
            }
            RowLayout {
                spacing: 24
                InfoCard {
