        ...
        Page {
            ...
            footer: ColumnLayout {
                PrimaryButton {
                    ...
                    Layout.margins: 0
                    Layout.Layout.leftMargin: 24
                    Layout.Layout.rightMargin: 24
                    Layout.Layout.bottomMargin: 12
            ...
            header: RowLayout {
                ColumnLayout {
                    Layout.margins: 0
                    Layout.Layout.leftMargin: 16
                    Layout.Layout.rightMargin: 0
                    Layout.Layout.topMargin: 16
                    spacing: 10
                    Label {
                        Layout.fillWidth: true
