...
Page {
    ...
    header: Pane {
        ...
        contentItem: RowLayout {
            spacing: 4
            TabButton2 {
                Layout.Layout.leftMargin: stack_layout.x - 32
                index: 0
    ...
    component VSeparator: Rectangle {
        Layout.Layout.leftMargin: 10
        Layout.Layout.rightMargin: 10
        color: '#FFFFFF'
        implicitHeight: 14
        implicitWidth: 1
        opacity: 0.7
    ...
    component ListPage: Page {
        ...
        header: TTextField {
            ...
            RowLayout {
                id: left_layout
                anchors.Layout.Layout.leftMargin: 15
            ...
            RowLayout {
                id: right_layout
                anchors.Layout.Layout.rightMargin: 15
                anchors.verticalCenter: parent.verticalCenter
                anchors.right: parent.right
                spacing: 12
                Repeater {
            ...
            Label {
                ...
                anchors.left: parent.left
                anchors.Layout.Layout.leftMargin: search_field.leftPadding
