    ...
    contentItem: ColumnLayout {
        ...
        HPane {
            contentItem: RowLayout {
                ...
                CircleButton {
                    Layout.Layout.leftMargin: 6
                    Layout.Layout.rightMargin: 6
                    id: tool_button
                ...
                RowLayout {
                    ...
                    Layout.Layout.leftMargin: 20
                    Layout.Layout.rightMargin: 20
                    id: task_info_layout
        ...
        HPane {
            ...
            background: Rectangle {
                ...
                Image {
                    ...
                    anchors.Layout.Layout.leftMargin: 16
